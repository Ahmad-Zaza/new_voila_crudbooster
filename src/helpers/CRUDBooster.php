...
class CRUDBooster
{
    ...
    public static function mainpath($path = null)
    {
        ...
        $controllername = str_replace(["\voila_crudbooster\crudbooster\controllers\\", "App\Http\Controllers\\"], "", strtok(Route::currentRouteAction(), '@'));
...
//     }
    ...
    public static function generateAPI($controller_name, $table_name, $permalink, $method_type = 'post')
    {
		...
		class Api'.$controller_name.'Controller extends \voila_crudbooster\crudbooster\controllers\ApiController {
...
<?php namespace App\Http\Controllers;
	...
	class Admin'.$controllername.' extends \voila_crudbooster\crudbooster\controllers\CBController {
